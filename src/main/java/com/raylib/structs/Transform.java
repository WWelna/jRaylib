...
@Structure.FieldOrder({"translation", "rotation", "scale"})
public class Transform extends Structure {
	
	public Transform() { super(); }
	public Transform(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends Transform implements Structure.ByValue {
		...
		public Transform.ByReference getReference() { return new Transform.ByReference(this.getPointer()); }
	}
	
	public Vector3.ByValue translation;
	public Vector3.ByValue /* Quaternion */ rotation;
	public Vector3.ByValue scale;
}
