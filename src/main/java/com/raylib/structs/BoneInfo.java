...
@Structure.FieldOrder({"name", "parent"})
public class BoneInfo extends Structure {
	
	public BoneInfo() { super(); }
	public BoneInfo(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends BoneInfo implements Structure.ByValue {
		...
		public BoneInfo.ByReference getReference() { return new BoneInfo.ByReference(this.getPointer()); }
	}
