...
@Structure.FieldOrder({"position", "direction"})
public class Ray extends Structure {
	
	public Ray() { super(); }
	public Ray(Pointer peer) { super(peer); read(); }
	
	public static class ByReference extends Ray implements Structure.ByReference {
	...
	public static class ByValue extends Ray implements Structure.ByValue {
		...
		public Ray.ByReference getReference() { return new Ray.ByReference(this.getPointer()); }
		
	}
	
	public Vector3.ByValue position;
	public Vector3.ByValue direction;
}
