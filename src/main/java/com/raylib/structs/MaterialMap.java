...
@Structure.FieldOrder({"texture", "color", "value"})
public class MaterialMap extends Structure {
	
	public MaterialMap() { super(); }
	public MaterialMap(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends MaterialMap implements Structure.ByValue {
		...
		public MaterialMap.ByReference getReference() { return new MaterialMap.ByReference(this.getPointer()); }
	}
	
	public Texture.ByValue texture;
	public Color.ByValue color;
	public float value;
}
