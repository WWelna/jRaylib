...
@Structure.FieldOrder({"boneCount", "frameCount", "bones", "framePoses"})
public class ModelAnimation extends Structure {
	
	public ModelAnimation() { super(); }
	public ModelAnimation(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends ModelAnimation implements Structure.ByValue {
		...
		public ModelAnimation.ByReference getReference() { return new ModelAnimation.ByReference(this.getPointer()); }
	}
