...
@Structure.FieldOrder({"id", "locs"})
public class Shader extends Structure {
	
	public Shader() { super(); }
	public Shader(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends Shader implements Structure.ByValue {
		...
		public Shader.ByReference getReference() { return new Shader.ByReference(this.getPointer()); }
	}
