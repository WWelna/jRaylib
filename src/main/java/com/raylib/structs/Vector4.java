...
public class Vector4 extends Structure {
	...
	public Vector4() { super(); }
	public Vector4(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends Vector4 implements Structure.ByValue {
		...
		public Vector4.ByReference getReference() { return new Vector4.ByReference(this.getPointer()); }
	...
	public String toString() {
		return new String("Vector4["+this.x+","+this.y+","+this.z+","+this.w+"]");
	}
