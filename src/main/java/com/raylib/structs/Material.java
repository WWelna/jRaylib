...
@Structure.FieldOrder({"shader", "maps", "params"})
public class Material extends Structure {
	
	public Material() { super(); }
	public Material(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends Material implements Structure.ByValue {
		...
		public Material.ByReference getReference() { return new Material.ByReference(this.getPointer()); }
	}
	
	public Shader.ByValue shader;
	public MaterialMap[] maps = new MaterialMap[12]; /* #define MAX_MATERIAL_MAPS       12    // Maximum number of maps supported */
	public float[] params = new float[4];
}
