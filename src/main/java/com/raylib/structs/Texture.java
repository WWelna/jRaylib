...
@Structure.FieldOrder({"id", "width", "height", "mipmaps", "format"})
public class Texture extends Structure {
	
	public Texture() { super(); }
	public Texture(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends Texture implements Structure.ByValue {
		...
		public Texture.ByReference getReference() { return new Texture.ByReference(this.getPointer()); }
	}
