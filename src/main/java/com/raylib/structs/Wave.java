...
@Structure.FieldOrder({"frameCount", "sampleRate", "sampleSize", "channels", "data"})
public class Wave extends Structure {
	
	public Wave() { super(); }
	public Wave(Pointer peer) { super(peer); read(); }
	...
	public static class ByValue extends Wave implements Structure.ByValue {
		...
		public Wave.ByReference getReference() { return new Wave.ByReference(this.getPointer()); }
	}
