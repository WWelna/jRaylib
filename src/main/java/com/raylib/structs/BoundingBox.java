...
public class BoundingBox extends Structure {
	...
	public BoundingBox(Pointer peer) { super(peer); read(); }
	
	public static class ByReference extends BoundingBox implements Structure.ByReference {
	...
	public static class ByValue extends BoundingBox implements Structure.ByValue {
		...
		public BoundingBox.ByReference getReference() { return new BoundingBox.ByReference(this.getPointer()); }
		
		public ByValue(Vector3.ByValue min, Vector3.ByValue max) {
			super();
			this.min = min;
			this.max = max;
		}
	...
	public Vector3.ByValue min;
	public Vector3.ByValue max;
}
